document.addEventListener("DOMContentLoaded", function () {
      ...
      fetch(query, {
          ...
          .then(data => {
              if (data.length == 0) {
                  ...
                  productos.innerHTML += `<div class="card mb-3" style="width: 40vw; background-color: rgb(146, 146, 146); display: flex; flex-direction: row;">
                          <div class="col-md-6" style="display: flex; justify-content: center; align-items: center;">
                              <p>Precio total: ${precioTotal} €</p>
                          </div>
                          <div class="col-md-6" style="display: flex; justify-content: center; align-items: center;">
                              <div class="card-body">
                                    <div id="buttContainer" style="width: 100%; height: 2vw; display: flex; flex-direction: row; justify-content: center; align-items: center;">
                                        <button id='actu' class="botonesCRUD actuaBtn" type="submit" name="actualizar" style="width: 6.3vw; font-size: 0.8vw; height: 2vw;">Actualizar</button>
                                        <div style="width: 4vw;"></div>
                                        <button id='compr' class="botonesCRUD comprarBtn" type="submit" name="comprar" style="width: 6.3vw; font-size: 0.8vw; height: 2vw;">Comprar</button>
                                    </div>
                              </div>
                          </div>
                      </div>`;
  ...
  function actualizarComprar() {
    let comprarBtn = document.getElementById('compr');

    comprarBtn.addEventListener('click', function(){ 
        setTimeout(function () {
            window.location.href = "../controlers/confirmar.php";
        }, 1000);
    });
  }
