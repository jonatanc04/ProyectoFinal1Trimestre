                          ...
                          <div class="col-md-6" style="display: flex; justify-content: center; align-items: center;">
                              <div class="card-body">
                                    <div id="buttContainer" style="width: 100%; height: 2vw; display: flex; flex-direction: row; justify-content: center; align-items: center;">
                                        <button class="botonesCRUD actuaBtn" type="submit" name="actualizar" style="width: 6vw; font-size: 0.8vw; height: 2vw;">Actualizar</button>
                                        <div style="width: 4vw;"></div>
                                        <button class="botonesCRUD comprarBtn" type="submit" name="comprar" style="width: 6vw; font-size: 0.8vw; height: 2vw;">Comprar</button>
                                    </div>
                              </div>
                          </div>
                      </div>`;
